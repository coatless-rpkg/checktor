...
- **NOTE** -- something a reviewer will likely ask about. A submission with NOTEs
  can still be accepted, but each one needs a reason.
- **WARNING** -- a real problem. CRAN will not accept a package with a WARNING.
- **ERROR** -- the check could not complete, usually because code or a test failed
  outright.
...
("is this package good?"), which is exactly the gap the reviewer -- and checktor --
fills in.
