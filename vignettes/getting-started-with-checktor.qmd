...
> **On your own package**, the call is simply `checktor()`. Like
> `devtools::check()`, it works from anywhere inside the package, so calling it
> with your working directory in `R/` or `tests/testthat/` still examines the
> whole package.
