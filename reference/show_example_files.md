...
#>  [4] "code_examples/globalenv_bad.R"                      
#>  [5] "code_examples/option_changes_bad.R"                 
#>  [6] "code_examples/print_cat_bad.R"                      
#>  [7] "code_examples/seed_setting_bad.R"                   
#>  [8] "code_examples/tf_usage_bad.R"                       
#>  [9] "description_examples/bad_description.txt"           
#> [10] "description_examples/good_description.txt"          
#> [11] "documentation_examples/good_documentation.Rd"       
#> [12] "documentation_examples/missing_examples_bad.Rd"     
#> [13] "documentation_examples/missing_value_tag.Rd"        
#> [14] "documentation_examples/suggested_in_examples_bad.Rd"
#> [15] "network_examples/bad_network_example.Rd"            
#> [16] "temp_examples/bad_temp_usage.R"                     

# List only code examples
show_example_files("code")
#> [1] "code_examples/browser_calls_bad.R"  "code_examples/core_usage_bad.R"    
#> [3] "code_examples/credentials_bad.R"    "code_examples/globalenv_bad.R"     
#> [5] "code_examples/option_changes_bad.R" "code_examples/print_cat_bad.R"     
#> [7] "code_examples/seed_setting_bad.R"   "code_examples/tf_usage_bad.R"      
...
#>  [8] "code_examples/tf_usage_bad.R"                       
#>  [9] "description_examples/bad_description.txt"           
#> [10] "documentation_examples/missing_examples_bad.Rd"     
#> [11] "documentation_examples/suggested_in_examples_bad.Rd"
